...
/**
 * This interface is intended to abstract the interaction with the vending
 * machine's user interface.
 * <p>
 * Note: These functions do not validate if they function correctly, meaning you
 * can call `dispenseProduct` even if the machine does not contain any products,
